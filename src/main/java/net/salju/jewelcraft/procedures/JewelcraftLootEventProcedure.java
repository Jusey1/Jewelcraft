...
public class JewelcraftLootEventProcedure {
	...
	public void onLoot(LootTableLoadEvent event) {
		if (event.getName().equals(BuiltInLootTables.SHIPWRECK_TREASURE)) {
			...
			LootPool unique = JewelcraftHelpersProcedure.setUnique("captain_loot", -3.0F, 1.0F,
			...
			LootTable table = event.getTable();
			LootPool unique = JewelcraftHelpersProcedure.setUnique("jungle_loot", -3.0F, 1.0F,
			...
			LootTable table = event.getTable();
			LootPool unique = JewelcraftHelpersProcedure.setUnique("desert_loot", -3.0F, 1.0F,
			...
			LootTable table = event.getTable();
			LootPool unique = JewelcraftHelpersProcedure.setUnique("fish_loot", -24.0F, 1.0F,
